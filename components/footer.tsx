...
export function Footer() {
  ...
  return (
    <footer className="relative bg-background border-t border-border py-12 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-32 bg-primary/10 rounded-full blur-[100px]" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Tagline */}
          <p className="text-muted-foreground text-center">Built with trust, security, and innovation</p>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="p-2 rounded-xl hover:bg-primary/10 hover:glow-primary transition-all duration-300"
              aria-label="LinkedIn"
            >
